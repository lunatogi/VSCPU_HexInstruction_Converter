Converts human readable custom (VSCPU) ISA assembly code into a 32-bit hexadecimal number or vice versa. This can be done individually or by retrieving a list from a .txt file.
